...
type SearchBarFilterProps<scope_value extends string = string> = SearchBarSharedProps<scope_value> & {
  variant: 'filter'
}

type SearchBarReplaceProps<scope_value extends string = string> = SearchBarSharedProps<scope_value> & {
  variant: 'replace'
  replace_text: string
...
export type SearchBarProps<scope_value extends string = string> =
      ...
      <CardContent className="search-bar__content">
        ...
        >
          ...
          <div className="search-bar__actions">
            <SearchBarScopeAction
              disabled={disabled}
              scope={scope}
            />
            <SearchBarRegexAction
              disabled={disabled}
              regex={regex}
            />

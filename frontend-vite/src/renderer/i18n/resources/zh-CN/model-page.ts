export const zh_cn_model_page = {
  ...
  dialog: {
    basic: {
      title: '基础设置',
      description: '在这里维护模型名称、接口地址、密钥、模型标识和思考等级。',
    },
    task: {
      title: '任务设置',
      description: '这里负责限制模型在单次任务中的输入、输出、并发和 RPM 阈值。',
    },
    advanced: {
      title: '高级设置',
      description: '这里负责生成参数以及额外请求头、请求体等高级能力。',
    },
    selector: {
      title: '可用的模型列表',
      description: '点击列表项后会立即写回模型标识。',
      loading: '正在获取模型列表 …',
  ...
  confirm: {
    delete: {
      title: '确认删除模型',
      description: '删除后会从当前分类移除该模型，并立即刷新模型页快照。',
      confirm: '确认删除',
    },
    reset: {
      title: '确认重置模型',
      description: '重置后会恢复预设模型的默认配置。',
      confirm: '确认重置',
    },
  },
  feedback: {

...
function should_ignore_row_click_target(target_element: HTMLElement): boolean {
  return target_element.closest('[data-text-preserve-ignore-row-click="true"]') !== null
}
    ...
    return [
      {
        ...
        render_cell: (payload) => {
          const utility = (
            ...
            >
              <span className="text-preserve-page__drag-handle" aria-hidden="true">
                <GripVertical />
              </span>
              <span className="text-preserve-page__row-index">

...
import { WorkbenchTableActionMenu, WorkbenchTableContextMenuContent } from '@/pages/workbench-page/components/WorkbenchTableActionMenu'
            ...
            <Table variant="card" density="compact" className="workbench-page__table">
              ...
              <TableBody>
                {props.entries.map((entry, index) => {
                  const is_selected = entry.id === props.selected_entry_id
                    ...
                    <ContextMenu key={entry.id}>
                      <ContextMenuTrigger asChild>
                        <TableRow
                          ...
                          onClick={() => props.on_select(entry.id)}
                        >
                          ...
                          <TableCell className="workbench-page__table-action-cell">
                            <WorkbenchTableActionMenu
                              ...
                              on_replace={() => props.on_replace(entry.id)}
                              on_reset={() => props.on_reset(entry.id)}
                              on_delete={() => props.on_delete(entry.id)}
                            />
                          </TableCell>
                        </TableRow>
                      </ContextMenuTrigger>

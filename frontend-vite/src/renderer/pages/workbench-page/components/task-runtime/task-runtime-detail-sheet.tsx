...
import { WORKBENCH_WAVEFORM_VISIBLE_POINTS } from '@/lib/workbench-waveform'
import type {
...
function TaskWaveform(props: {
  ...
  return (
    <div className="task-runtime__waveform">
      <canvas
        ref={canvas_ref}
        className="task-runtime__waveform-canvas"
        aria-hidden="true"
      />
    </div>
  )
...
export function TaskRuntimeDetailSheet(
  props: TaskRuntimeDetailSheetProps,
): JSX.Element {
  return (
    <Sheet
      open={props.open}
        ...
        <div className="task-runtime__sheet-body">
          <section className="task-runtime__section">
            <div className="task-runtime__section-head task-runtime__section-head--inline">
              <h3 className="task-runtime__section-title">
                {props.view_model.waveform_title}
              </h3>
              <span
                className={cn(
          ...
          <section className="task-runtime__section">
            <div className="task-runtime__section-head">
              <h3 className="task-runtime__section-title">
                {props.view_model.metrics_title}
              </h3>
            </div>

...
import { project_home_mock, type ProjectHomeRecentProject } from '@/pages/project/home/mock'
...
type RecentProjectRowProps = {
  project: ProjectHomeRecentProject
  on_select: (project: ProjectHomeRecentProject) => void
}
  ...
  return (
    <header className="flex items-start gap-3">
      ...
      <div className="space-y-0.5">
        <h2 className="text-[clamp(1.62rem,1.48rem+0.34vw,1.92rem)] leading-[1.08] font-semibold tracking-[-0.028em] text-foreground">
          {props.title}
        </h2>
        <p className="max-w-[520px] text-[0.8rem] leading-[1.45] text-[color:var(--project-home-subtitle)]">{props.subtitle}</p>
      </div>
    </header>
  )
}
  ...
  return (
    <div
      className={cn(
        ...
        props.is_compact ? 'h-[145px] px-5 py-4' : 'h-[145px] px-5 py-4',
      )}
      role="button"
      tabIndex={0}
      aria-disabled="true"
...
function FormatSupportCard(props: FormatSupportCardProps): JSX.Element {
  return (
    <Card className="project-home__format-card px-3 py-3">
      <div className="space-y-0.5">
...
function ProjectPreviewPanel(props: ProjectPreviewPanelProps): JSX.Element {
  ...
  return (
    <Card className="project-home__preview-card px-4 py-4">
      <div className="space-y-3">
        ...
        <div className="space-y-2.5 pt-1">
          ...
          <div className="h-1.5 rounded-full bg-[color:var(--project-home-progress-track)]">
            <div
              className="h-full rounded-full bg-[color:var(--project-home-progress-fill)] transition-[width] duration-300"
              style={{ width: `${props.project.preview.progress_percent}%` }}
            />
          </div>
...
export function ProjectHomePage(props: ProjectHomePageProps): JSX.Element {
  const { t } = useI18n()
  const [selected_project, set_selected_project] = useState<ProjectHomeRecentProject | null>(null)
  const has_recent_projects = project_home_mock.recent_projects.length > 0

  return (
    <div className="project-home workspace-scroll" data-sidebar-collapsed={String(props.is_sidebar_collapsed)}>
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <Card className="project-home__panel min-h-[696px] px-6 pt-5 pb-6 xl:px-6 xl:pt-5 xl:pb-6">
            <div className="flex h-full flex-col gap-5">
              ...
              <section className="space-y-3 pt-2">
                ...
                <div className="grid gap-2 md:grid-cols-2">
                  {project_home_mock.supported_formats.map((format_item) => (
                    <FormatSupportCard
                      key={format_item.id}
              ...
              <div className="mt-auto flex justify-center pt-4">
                <Button className="project-home__action min-w-[160px]" disabled>
        ...
        <Card className="project-home__panel min-h-[696px] px-6 pt-5 pb-6 xl:px-6 xl:pt-5 xl:pb-6">
            <div className="flex h-full flex-col gap-5">
              ...
              {selected_project !== null ? (
                ...
                <DropZoneCard icon="project" tone="purple" title={t('common.project.home.open.drop_title')} is_compact />
              )}
              ...
              <section className="space-y-2.5 pt-2">
                ...
                {selected_project !== null ? (
                  ...
                  <div className="space-y-1">
                    {project_home_mock.recent_projects.map((project_item) => (
                      <RecentProjectRow
                        key={project_item.id}
                  ...
                  <div className="project-home__empty-state">
                    <ShieldAlert className="size-12 stroke-[1.8]" />
                    <p>{t('common.project.home.open.empty')}</p>
                  </div>
                )}
              </section>

              <div className={cn('mt-auto flex justify-center', selected_project === null ? 'pt-4' : 'pt-6')}>
                <Button className="project-home__action min-w-[160px]" disabled={selected_project === null}>

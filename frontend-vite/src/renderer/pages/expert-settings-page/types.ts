...
export function build_expert_settings_snapshot(settings_snapshot: SettingsSnapshot): ExpertSettingsSnapshot {
  return {
    ...
    auto_process_prefix_suffix_preserved_text: settings_snapshot.auto_process_prefix_suffix_preserved_text,
  }
}

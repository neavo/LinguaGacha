...
import { ProofreadingToolbar } from '@/pages/proofreading-page/components/proofreading-toolbar'
import {
  Alert,
  AlertAction,
  AlertDescription,
...
export function ProofreadingPage(props: ScreenComponentProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <ProofreadingToolbar
        search_keyword={proofreading_page_state.search_keyword}
        replace_text={proofreading_page_state.replace_text}
        is_regex={proofreading_page_state.is_regex}
        invalid_regex_message={proofreading_page_state.invalid_regex_message}
        disabled={toolbar_disabled}
        on_search_keyword_change={proofreading_page_state.update_search_keyword}
        on_replace_text_change={proofreading_page_state.update_replace_text}
        on_regex_change={proofreading_page_state.update_regex}
        ...
        on_open_filter={proofreading_page_state.open_filter_dialog}
      />

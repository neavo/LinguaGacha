...
- 以 “全局最优而非最小改动” “勇于重构和删减，避免过度设计、过度防御和补丁式修改” “重视代码维护成本、降低结构理解成本” 为原则，未经用户确认不得引入兼容层
...
- `AGENTS.md` 不承载专题正文，系统、后端、CLI、前端、验证规则分别归入 `ARCHITECTURE`、`BACKEND`、`CLI`、`FRONTEND`、`WORKFLOW`

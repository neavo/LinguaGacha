...
既有 glossary 条目的 `seed: true` 需要用户明确指定，或工程证据支持专有身份、作品特有概念、身份、指代、消歧或非普通翻译可稳定推出的固定译法需求。固定译文、命中频率、共享词根和相似性只作为补查证据。
...
- **译文与长尾**：`dst` / `name_dst` 的译法分歧、原文残留、身份线索、现有规则未覆盖的文件长尾与单次概念。

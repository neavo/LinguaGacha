...
- 20260918 v0.122.0
  - 新增 `.pdf` 文件支持 [#895](../../issues/895)
    - 只能在 `AGENT` 模式翻译
    - 支持 `普通文本` 和 `图片文本`
  - 支持 `OpenCode Go` 特殊字段规则 [#894](../../issues/894)
  - 修复与改进 [#877](../../issues/877)  [#888](../../issues/888) [#890](../../issues/890) [#891](../../issues/891) [#892](../../issues/892) [#893](../../issues/893) [#896](../../issues/896) [#897](../../issues/897) [#898](../../issues/898) [#899](../../issues/899)

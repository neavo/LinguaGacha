...
import type { AppSessionProofreadingCache } from "../../app/app-session-proofreading-cache";
import { ProjectSessionState } from "../project-session-state";
import { ProofreadingQueryService } from "./proofreading-query-service";

function create_cache(): AppSessionProofreadingCache {
  const base_result = {
  ...
  } as unknown as AppSessionProofreadingCache;
}

describe("ProofreadingQueryService", () => {
  it("把 sync 请求收窄后交给 AppSessionProofreadingCache 并保留公开响应形状", async () => {

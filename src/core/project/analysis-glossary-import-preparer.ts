...
import type { AppSessionCachedItem } from "../app/app-session-cache";
import type { ProjectRuntimeProjectionMutableRecord } from "./project-runtime-projection-service";
...
function read_existing_glossary_entries(
  quality_block: ProjectRuntimeProjectionMutableRecord,
): GlossaryEntry[] {

...
import type { TranslationTokenCountResult } from "./token-metric-cache";
...
class PlanningWorkerEntry {
  ...
  /**
   * 消息入口只分发 count 与 cancel，业务规划语义留在主线程 TranslationPlanner。
   */
   ...
   */
  private async count_tokens(
    message: PlanningCountTokensMessage,

...
export type QualityRuleStatisticsWorkerTaskResult = {
...
/** 执行一次质量规则统计；hits 与 examples 共用扫描，父项仅在缓存缺失时计算。 */
export function run_quality_rule_statistics_worker_task(
  input: QualityRuleStatisticsWorkerTaskInput,

...
import { format_agent_workspace_typescript_api } from "../methods/api-description";
...
const WORKSPACE_SCRIPT_API_DESCRIPTION = [
  ...
  "业务路径与字段以 workspace.contract 为准。示例：const meta = JSON.parse(await Deno.readTextFile(workspace.contract.datasets.project_meta.path)); return { counts: meta.counts };",
].join("\n");

...
import { createProjectPrefilterClient } from "./prefilter-worker-client";
import { compute_project_prefilter_mutation } from "./prefilter-mutation-builder";
import type { ProjectPrefilterMutationInput } from "./prefilter-mutation-builder";
...
vi.mock("./prefilter-mutation-builder", () => {
  return {

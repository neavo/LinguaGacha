...
function create_quality_slice(overrides: Partial<QualitySlice> = {}): QualitySlice {
  return {
...
function create_quality_state(): QualitySnapshot {
  return {
...
function create_prompt_slice(text: string): PromptSlice {
  return {
    text,
    enabled: true,
    revision: 1,
...
function create_prompt_state(): PromptsSnapshot {
  return {

export const en_us_agent_page = {
  ...
  approval: {
    ...
    summary_pre_replacement: "{count} pre-replacement rules",
    summary_post_replacement: "{count} post-replacement rules",
    summary_prompts: "{count} custom prompts",
    summary_separator: ", ",
    summary_last_separator: ", and ",
    reject: "Reject",
    approve_once: "Allow once",
    approve_future: "Allow future writes for this task",
  },
  compaction: {
  ...
  error: {
    ...
    approval_decision: "The write request could not be processed. Try again.",

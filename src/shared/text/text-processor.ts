...
export class TextProcessor {
  ...
  /**
   * 绑定 config、item 和质量快照；处理器不读取全局 会话缓存。
   */
  public constructor(
  ...
  /**
   * 正则替换兼容历史正则替换 的常见反向引用，同时避免 JS `$&/$1` 语义误伤字面量。
   */

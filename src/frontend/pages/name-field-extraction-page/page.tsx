import "@frontend/pages/name-field-extraction-page/name-field-extraction-page.css";
import type { ScreenComponentProps } from "@frontend/app/navigation/types";
import { useI18n, type LocaleKey } from "@frontend/app/locale/locale-provider";
import { NameFieldExtractionCommandBar } from "@frontend/pages/name-field-extraction-page/components/name-field-extraction-command-bar";
import { NameFieldExtractionConfirmDialog } from "@frontend/pages/name-field-extraction-page/components/name-field-extraction-confirm-dialog";
import { NameFieldExtractionEditDialog } from "@frontend/pages/name-field-extraction-page/components/name-field-extraction-edit-dialog";
import { NameFieldExtractionTable } from "@frontend/pages/name-field-extraction-page/components/name-field-extraction-table";
import type { NameFieldFilterScope } from "@frontend/pages/name-field-extraction-page/types";

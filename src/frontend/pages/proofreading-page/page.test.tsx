...
vi.mock("@frontend/pages/proofreading-page/components/proofreading-filter-dialog", () => {
  return {
    ProofreadingFilterDialog: () => null,
  };
});

vi.mock("@frontend/pages/proofreading-page/components/proofreading-edit-dialog", () => {
  return {

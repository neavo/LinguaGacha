import type { AppTableSelectionMode } from "@frontend/widgets/app-table/app-table-types";
...
export function resolve_app_table_drag_group_row_ids(args: {
  ...
  if (args.selection_mode === "multiple" && args.selected_row_ids.includes(args.active_row_id)) {

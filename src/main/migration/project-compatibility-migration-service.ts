...
const LEGACY_TRANSLATION_PROMPT_ZH_RULE_TYPE = "CUSTOM_PROMPT_ZH"; // 旧翻译提示词按语言拆成两个原始规则槽位，迁移时只读取一次
const LEGACY_TRANSLATION_PROMPT_EN_RULE_TYPE = "CUSTOM_PROMPT_EN";
const LEGACY_TRANSLATION_PROMPT_MIGRATED_META_KEY = "translation_prompt_legacy_migrated"; // 迁移标记避免用户清空当前提示词后被旧槽位反复写回
const TRANSLATION_PROMPT_RULE_TYPE = "translation_prompt"; // 当前工程只暴露单一 translation_prompt 物理槽位

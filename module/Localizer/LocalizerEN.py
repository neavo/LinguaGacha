...
class LocalizerEN(LocalizerZH):
    ...
    proofreading_page_desc: str = "Review translations, fix errors and export"
    ...
    proofreading_page_readonly_mode: str = "Translation in progress, proofreading locked"
    proofreading_page_unsaved_alert: str = "You have unsaved changes. Save before leaving?"
    proofreading_page_save_success: str = "Data saved"
    proofreading_page_export_success: str = "Export completed"
    proofreading_page_stats: str = "Loaded {TOTAL} | Errors {ERROR}"
    ...
    proofreading_page_filter_error_type: str = "Error Type"
    proofreading_page_filter_status: str = "Translation Status"
    proofreading_page_filter_file: str = "File"
    proofreading_page_filter_all: str = "All"
    proofreading_page_status_none: str = "Untranslated"
    proofreading_page_status_processing: str = "Processing"
    proofreading_page_status_processed: str = "Completed"
    proofreading_page_status_processed_in_past: str = "Past Completed"
    proofreading_page_status_excluded: str = "Excluded"
    proofreading_page_status_duplicated: str = "Duplicated"
    proofreading_page_discard: str = "Discard"
    proofreading_page_save_and_continue: str = "Save & Continue"
    proofreading_page_prev_page: str = "Previous"
    proofreading_page_next_page: str = "Next"
    proofreading_page_page_info: str = "Page {CURRENT} / {TOTAL}"
    proofreading_page_per_page: str = "Per page"
    proofreading_page_items: str = "items"
    proofreading_page_error_kana: str = "Kana Residue"
    proofreading_page_error_hangeul: str = "Hangeul Residue"
    proofreading_page_error_text_preserve: str = "Text Preserve Failed"

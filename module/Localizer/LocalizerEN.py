...
class LocalizerEN(LocalizerZH):
    ...
    translation_page_export: str = "Generate"
    ...
    proofreading_page_col_translation_status: str = "Translation Status"
    proofreading_page_col_result_check: str = "Result Check"
    proofreading_page_glossary_toggle: str = "Glossary"
    ...
    proofreading_page_unsaved_discard: str = "Discard Changes"

...
class LocalizerEN(LocalizerZH):
    ...
    proofreading_page_recheck: str = "Recheck"
    ...
    proofreading_page_stats: str = "Loaded {TOTAL} | Errors {ERROR} | Modified {MODIFIED}"
    ...
    proofreading_page_error_untranslated: str = "Untranslated"

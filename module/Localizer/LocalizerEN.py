...
class LocalizerEN(LocalizerZH):
    ...
    analysis_page_reset_failed: str = "Reset Failed Files"
    analysis_page_reset_all: str = "Reset All Progress"
    analysis_page_alert_reset_failed: str = "Confirm to reset failed files? You can continue analyzing after reset …?"
    ...
    analysis_page_reset_tooltip: str = "Click to choose resetting failed files or all analysis progress"
    analysis_task_terms_added: str = "Added {COUNT} terms"

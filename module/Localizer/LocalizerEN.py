...
class LocalizerEN(LocalizerZH):
    ...
    workbench_stat_total_items: str = "Total Items"
    ...
    workbench_fmt_text_file: str = "Text File"
    workbench_toast_add_success: str = "File added"
    workbench_toast_update_success: str = "File updated"
    workbench_toast_reset_success: str = "File reset"
    workbench_toast_delete_success: str = "File deleted"
    workbench_update_stat: str = "Matched {MATCHED}, added {NEW}"
    workbench_page_info: str = "Page {CURRENT} / {TOTAL}"

...
class LocalizerEN(LocalizerBase):
    ...
    project_page_source_language_items: str = "Chinese,English,Japanese,Korean,Russian,German,Indonesian,Vietnamese"
    ...
    project_page_target_language_items: str = "Chinese,English,Japanese,Korean,Russian,German,Indonesian,Vietnamese"

...
class LocalizerEN(LocalizerZH):
    ...
    proofreading_page_filter_title: str = "Filter & Check"
    ...
    proofreading_page_filter_term_count: str = "{count}x"
    proofreading_page_filter_selected_info: str = "{count} items selected (from {files} files)"

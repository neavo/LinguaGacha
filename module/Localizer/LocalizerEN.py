...
class LocalizerEN(LocalizerZH):
    ...
    engine_task_scheduler_force_accept_source: str = "Forced Accept [FALLBACK_TO_SOURCE]: {TEXT}"
    engine_task_scheduler_force_accept_last: str = "Forced Accept [LAST_RESPONSE]: {TEXT}"
    ...
    translator_response_check_fail: str = "Translated text failed check, will automatically retry …"
    translator_response_check_fail_all: str = "All translated text failed check, will automatically split and retry …"
    translator_response_check_fail_part: str = "Partial translated text failed check, will automatically split and retry …"

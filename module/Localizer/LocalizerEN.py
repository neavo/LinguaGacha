...
class LocalizerEN(LocalizerZH):
    ...
    task_close_failed: str = "Task close failed …"
    ...
    translator_task_hard_timeout: str = "Request timed out ({SECONDS}s). The task will be treated as failed (the scheduler will split/retry if enabled) …"

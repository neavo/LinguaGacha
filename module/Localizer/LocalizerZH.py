...
class LocalizerZH():
    ...
    proofreading_page_filter_title: str = "筛选与检查"
    ...
    proofreading_page_filter_term_count: str = "{count}次"
    proofreading_page_filter_selected_info: str = "已选中 {count} 个条目 (来自 {files} 个文件)"

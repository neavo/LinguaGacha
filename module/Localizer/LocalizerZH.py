...
class LocalizerZH:
    ...
    workbench_stat_total_items: str = "总条目数"
    ...
    workbench_col_item_count: str = "行数"
    ...
    workbench_fmt_text_file: str = "文本文件"
    workbench_toast_add_success: str = "添加文件成功"
    workbench_toast_update_success: str = "更新文件成功"
    workbench_toast_reset_success: str = "重置文件成功"
    workbench_toast_delete_success: str = "删除文件成功"
    workbench_update_stat: str = "匹配 {MATCHED} 条，新增 {NEW} 条"
    workbench_page_info: str = "第 {CURRENT} / {TOTAL} 页"

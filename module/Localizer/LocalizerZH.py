...
class LocalizerZH:
    ...
    translation_page_export: str = "生成译文"
    ...
    proofreading_page_col_translation_status: str = "翻译状态"
    proofreading_page_col_result_check: str = "结果检查"
    proofreading_page_glossary_toggle: str = "术语表"
    ...
    proofreading_page_unsaved_discard: str = "放弃修改"

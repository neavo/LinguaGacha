...
class LocalizerZH:
    ...
    analysis_page_reset_failed: str = "重置失败文件"
    analysis_page_reset_all: str = "重置全部进度"
    analysis_page_alert_reset_failed: str = "确定要重置失败文件吗，重置后可以继续分析 …?"
    analysis_page_alert_reset_all: str = "确定要重置全部分析进度吗，重置后将重新分析全部文本 …?"
    analysis_page_reset_tooltip: str = "点击可选择重置失败文件或全部分析进度"
    analysis_task_terms_added: str = "新增术语 {COUNT} 条"

...
class LocalizerZH():
    ...
    proofreading_page_desc: str = "检视翻译结果，修正错误并导出"
    proofreading_page_load: str = "加载"
    ...
    proofreading_page_recheck: str = "重新检查"
    proofreading_page_readonly_mode: str = "翻译任务运行中，校对模式已锁定"
    ...
    proofreading_page_stats: str = "已加载 {TOTAL} 条 | 错误 {ERROR} 条 | 已修改 {MODIFIED} 条"
    ...
    proofreading_page_filter_error_type: str = "错误类型"
    ...
    proofreading_page_discard: str = "不保存"
    proofreading_page_save_and_continue: str = "保存并继续"
    proofreading_page_prev_page: str = "上一页"
    proofreading_page_next_page: str = "下一页"
    proofreading_page_page_info: str = "第 {CURRENT} / {TOTAL} 页"
    proofreading_page_per_page: str = "每页"
    proofreading_page_items: str = "条"
    proofreading_page_error_kana: str = "假名残留"
    proofreading_page_error_hangeul: str = "谚文残留"
    proofreading_page_error_text_preserve: str = "文本保护失效"
    proofreading_page_error_similarity: str = "相似度过高"
    proofreading_page_error_glossary: str = "术语表未生效"
    proofreading_page_error_untranslated: str = "未翻译"

class TextBase:
    ...
    RU_SET: set[str] = {
        ...
        for start, end in (
            ...
            (
                0x0500,
                0x052F,
            ),  # 俄文字符扩展区（补充字符，包括一些历史字母和其他斯拉夫语言字符）
    ...
    # 德文字符 (Latin 扩展 + 特殊字符)
    DE_SET: set[str] = LATIN_SET | {"Ä", "Ö", "Ü", "ä", "ö", "ü", "ß"}
    ...
    # 西班牙文字符
    ES_SET: set[str] = LATIN_SET | {"ñ", "á", "é", "í", "ó", "ú", "ü"}

    # 意大利文字符
    IT_SET: set[str] = LATIN_SET | {"à", "è", "é", "ì", "ò", "ù"}
    ...
    # 匈牙利文字符
    HU_SET: set[str] = LATIN_SET | {"á", "é", "í", "ó", "ö", "ő", "ú", "ü", "ű"}

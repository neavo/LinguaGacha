...
| reset preview 公开预演 | `frontend/src/main/project/project-reset-preview-service.ts` + `frontend/src/main/database/` | TS Gateway 计算公开响应；翻译 all 预演只通过受保护 Python 解析桥复用 `FileManager.parse_asset()` |

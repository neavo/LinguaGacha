...
| Agent 磁盘工作区、私有 protocol 或宿主回调 | 运行 contract 投影、内置 recipe、工作区服务、跨 section 事务、protocol、Backend Runtime 生产者和 main 消费者测试；Electron API、目录权限或 recipe 执行流变化时补一次真实 Electron smoke |

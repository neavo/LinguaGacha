...
- `RuntimeOperationGate` 让技能写入与 Agent 执行互斥。技能写占用覆盖文件、偏好和集合发布，Agent 租约覆盖准备、运行、等待决定及收尾。
...
- [系统提示](../builtin/agent/system_prompt.md) 负责人格、任务与授权边界、技能选择、CodeAct、业务单元与提交、恢复和交付要求。

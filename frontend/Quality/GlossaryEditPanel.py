...
class GlossaryEditPanel(QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.add_labeled_row(
            card_layout, Localizer.get().glossary_page_table_row_01, self.src_edit
        )
        self.add_labeled_row(
            card_layout, Localizer.get().glossary_page_table_row_02, self.dst_edit
        )
        self.add_labeled_row(
            card_layout, Localizer.get().glossary_page_table_row_04, self.info_edit
        )

        self.case_rule = RuleWidget(
            parent=self.card,
            show_regex=False,
            show_case_sensitive=True,
            case_sensitive_enabled=False,
            on_changed=lambda regex, case: self.on_rule_changed(case),
        )
        self.add_labeled_row(
            card_layout, Localizer.get().rule_case_sensitive, self.case_rule
        )
    ...
    def bind_entry(self, entry: dict[str, Any], index: int) -> None:
        ...
        self.case_rule.set_case_sensitive_enabled(self.saved_entry["case_sensitive"])
    ...
    def clear(self) -> None:
        ...
        self.case_rule.set_case_sensitive_enabled(False)
        self.src_edit.set_error(False)
        self.update_button_states()
    ...
    def set_readonly(self, readonly: bool) -> None:
        ...
        self.case_rule.setEnabled(not readonly)
        self.update_button_states()

    def on_rule_changed(self, case_sensitive: bool) -> None:
        del case_sensitive
        self.update_button_states()
    ...
    def get_current_entry(self) -> dict[str, Any]:
        return {
            ...
            "case_sensitive": self.case_rule.get_case_sensitive_enabled(),
        }

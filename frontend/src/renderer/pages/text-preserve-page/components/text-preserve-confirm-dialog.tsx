...
const CONFIRM_COPY_BY_KIND: Record<
  NonNullable<TextPreserveConfirmState['kind']>,
  ConfirmCopy
> = {
  'delete-selection': {
    title_key: 'text_preserve_page.confirm.delete_selection.title',
    description_key: 'text_preserve_page.confirm.delete_selection.description',
    confirm_key: 'text_preserve_page.confirm.delete_selection.confirm',
    destructive: true,
  },
  'delete-preset': {
    title_key: 'text_preserve_page.confirm.delete_preset.title',
    description_key: 'text_preserve_page.confirm.delete_preset.description',
    confirm_key: 'text_preserve_page.confirm.delete_preset.confirm',
    destructive: true,
  },
  reset: {
    title_key: 'text_preserve_page.confirm.reset.title',
    description_key: 'text_preserve_page.confirm.reset.description',
    confirm_key: 'text_preserve_page.confirm.reset.confirm',
    destructive: false,
  },
  'overwrite-preset': {
    title_key: 'text_preserve_page.confirm.overwrite_preset.title',
    description_key: 'text_preserve_page.confirm.overwrite_preset.description',
    confirm_key: 'text_preserve_page.confirm.overwrite_preset.confirm',
    destructive: false,
  },
}

export function TextPreserveConfirmDialog(
  props: TextPreserveConfirmDialogProps,
): JSX.Element {
  const { t } = useI18n()

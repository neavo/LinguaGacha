import { consumeBootstrapStream, type BootstrapStreamEvent } from "./bootstrap-stream-consumer";
import {
...
type ProjectBootstrapLoaderArgs = {
  store: ProjectStoreApi;
  openBootstrapStream: () => AsyncIterable<BootstrapStreamEvent>;
};

export function createProjectBootstrapLoader(args: ProjectBootstrapLoaderArgs) {

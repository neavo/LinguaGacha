...
import { ProjectPagesProvider, useProjectPagesBarrier } from "@/app/state/project-pages-context";
...
vi.mock("@/pages/proofreading-page/use-proofreading-page-state", () => {
  return {
    useProofreadingPageState: () => proofreading_fixture.current,
  };
});

vi.mock("@/pages/workbench-page/use-workbench-live-state", () => {
  return {
    useWorkbenchLiveState: () => workbench_fixture.current,
  };
});

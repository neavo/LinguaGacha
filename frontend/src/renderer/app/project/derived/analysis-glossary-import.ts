...
import { collect_project_item_texts } from "@/app/project/store/project-item-texts";
import type {
  QualityStatisticsRelationCandidate,
  QualityStatisticsRuleInput,
} from "@/app/project/quality/quality-statistics";
import { getSharedQualityStatisticsWorkerPool } from "@/app/project/quality/quality-statistics-worker-pool";
import {
  getQualityRuleSlice,

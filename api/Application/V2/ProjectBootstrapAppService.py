...
from api.Contract.V2.BootstrapPayloads import BootstrapCompletedPayload
from api.Contract.V2.BootstrapPayloads import BootstrapStageCompleted
from api.Contract.V2.BootstrapPayloads import BootstrapStagePayload
from api.Contract.V2.BootstrapPayloads import BootstrapStageStarted


class V2ProjectBootstrapAppService:
    """把当前已加载项目编码成一次性的 V2 bootstrap 分段事件流。"""
    ...
    def iter_bootstrap_events(self, request: dict[str, object]):
        """按固定顺序输出 bootstrap 分段事件，供前端建立 V2 项目状态仓。"""
